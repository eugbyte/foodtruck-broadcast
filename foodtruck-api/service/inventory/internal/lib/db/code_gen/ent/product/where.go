...
// HasVendorProductDetails applies the HasEdge predicate on the "vendor_product_details" edge.
func HasVendorProductDetails() predicate.Product {
...
// HasVendorProductDetailsWith applies the HasEdge predicate on the "vendor_product_details" edge with a given conditions (other predicates).
func HasVendorProductDetailsWith(preds ...predicate.VendorProductDetail) predicate.Product {
	return predicate.Product(func(s *sql.Selector) {
		step := newVendorProductDetailsStep()
