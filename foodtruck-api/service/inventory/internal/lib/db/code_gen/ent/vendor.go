...
func (e VendorEdges) VendorProductDetailsOrErr() ([]*VendorProductDetail, error) {
	if e.loadedTypes[0] {
...
func (*Vendor) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case vendor.FieldName, vendor.FieldDescription:
...
// QueryVendorProductDetails queries the "vendor_product_details" edge of the Vendor entity.
func (v *Vendor) QueryVendorProductDetails() *VendorProductDetailQuery {
	return NewVendorClient(v.config).QueryVendorProductDetails(v)
}
